...
int initalRowOne, initalRowTwo, initalRowThree, initalColumnOne, initalColumnTwo, initalColumnThree;
int map;
...
int main()
{
    ...
    do{
        ...
        */
        ...
        {
            printf("%d\n", i*3);
            column_results[i] = main_board[i * 3];
            ...
            for(j = 1; j <= 2; j++){
                ...
                if(operators_array[i + 3 + (j * 3)] == '+'){
                    row_results[i] = row_results[i] + main_board[i + (j * 3)];
                }
                ...
                if(operators_array[j + (i * 3) - (i + 1)] == '+'){
                    column_results[i] = column_results[i] + main_board[j + (i*3)];
                }
                    ...
                    column_results[i] = column_results[i] * main_board[j + (1 * 3)];
                }
            }
        }
